                        ...
                        <article class="blog-post-wrap">
                            ...
                            <div class="entry-summary">
                                ...
                                <div class="blog-post-excerpt">
                                    <?php echo wp_kses_post(revolve_get_excerpt(get_the_content(), 200, '&#8594;')); ?>
                                </div>
                            </div>
                        </article>
                    <?php endwhile; ?>
                ...
                <?php if ($revolve_bquery->max_num_pages > 1) { // check if the max number of pages is greater than 1  ?>
                  <nav class="prev-next-posts">
                    <div class="prev-posts-link">
                      <?php
                          echo wp_kses( get_next_posts_link( esc_html__('Older Entries', 'revolve'), $revolve_bquery->max_num_pages ), array(
                            'nav' => array(
                                'class' => array(),
                            ),
                            'div' => array(
                    ...
                    <div class="next-posts-link">
                      <?php
                          echo wp_kses( get_previous_posts_link( esc_html__('Newer Entries', 'revolve') ), array(
                            'nav' => array(
                                'class' => array(),
                            ),
                            'div' => array(
