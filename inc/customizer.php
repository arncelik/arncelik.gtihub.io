...
function revolve_customize_register( $wp_customize ) {
	...
	*/
	...
	$wp_customize->add_setting( 'revolve_tpl_color', array( 'default' => '#E11B30', 'sanitize_callback' => 'sanitize_hex_color' ) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'revolve_tpl_color', 
		array(
			'label'      => esc_html__( 'Template Color', 'revolve' ),
			'section'    => 'colors',
			'settings'   => 'revolve_tpl_color',
		) ) 
	);
}
