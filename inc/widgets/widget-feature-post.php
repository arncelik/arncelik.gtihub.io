...
class Revolve_Feature_Post extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'description' => esc_html__('A widget that Shows Feature Post', 'revolve')
            )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            'feature_post1' => array(
                ...
                'revolve_widgets_title' => esc_html__('Feature Post 1', 'revolve'),
                'revolve_widgets_field_type' => 'selectpost',
            ),
            'feature_post2' => array(
                'revolve_widgets_name' => 'feature_post2',
                'revolve_widgets_title' => esc_html__('Feature Post 2', 'revolve'),
                'revolve_widgets_field_type' => 'selectpost',
            ),
            'feature_post3' => array(
                'revolve_widgets_name' => 'feature_post3',
                'revolve_widgets_title' => esc_html__('Feature Post 3', 'revolve'),
                'revolve_widgets_field_type' => 'selectpost',
            )
        );
