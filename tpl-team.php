...
get_header(); ?>
    ...
    <div id="team-control">
        ...
        <div class="team-search">
            <input class="team-search-box" type="text" placeholder="<?php esc_html__('Mr. Team Member', 'revolve'); ?>" />
                ...
                <div class='team-list-block'>
                    <?php foreach($revolve_post_stack as $revolve_team) : ?>
                        ...
                        <div class="team-image-wrap team-member" >
                            ...
                            <h2 class="team-member-name"><?php echo esc_html($revolve_team->post_title); ?></h2>
                        </div>
                        <div class="team-info" style="display: none;">
                            ...
                            <div class="team-inner-info">
                                <div class="bio">
                                    <h2><?php echo esc_html($revolve_team->post_title); ?></h2>
                                    <hr />
                                   
                                        <?php echo wp_kses_post($revolve_team->post_content); ?>
                                </div>
                ...
                <div class='team-list-block'>
                    <?php foreach($revolve_post_stack as $revolve_alpha => $revolve_teams) : ?>
                    	<div class="letter-group">
                            <h2><?php echo esc_html($revolve_alpha); ?></h2>
